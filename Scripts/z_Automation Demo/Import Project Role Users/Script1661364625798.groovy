...
WebUI.click(findTestObject('Convergence/_NavigationMenu/Administration Console/a_Import Components'))
...
WebUI.doubleClick(findTestObject('Convergence/Utilities/Import Components/btn_Complete Import'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2)

assertEquals('Components imported successfully. 10 User(s) Imported', selenium.getText('//p[@class="message"]'))
