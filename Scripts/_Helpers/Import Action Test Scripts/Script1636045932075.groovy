...
WebUI.waitForElementPresent(findTestObject('Convergence/_SelectProject/a_ActionTest'), 10, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Convergence/_SelectProject/a_ActionTest'), FailureHandling.CONTINUE_ON_FAILURE)
...
CustomKeywords.'cutomKeywords.UploadFile.uploadFile'(findTestObject('Convergence/Utilities/Import Components/btn_Import Upload'), 
    'C:\\actionTestFiles\\Template_Scripts\\CV_Automation_Action_Test_Import.zip')
