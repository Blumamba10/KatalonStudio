...
WebUI.setText(findTestObject('Convergence/Security/User Groups/_Add User Group/txt_Group Name'), 'Test User Group')

WebUI.setText(findTestObject('Convergence/Security/User Groups/_Add User Group/txt_Description'), 'Test User Group')

WebUI.click(findTestObject('Convergence/Security/User Groups/_Add User Group/btn_Save'))

WebUI.setText(findTestObject('Convergence/Security/User Groups/txt_Search Filter'), 'Test User Group')

selenium.click('//a[contains(text(),"Test User Group")]')
...
selenium.isElementPresent('//td[@style="text-align: right;"][contains(text(),"1")]')
...
assertEquals('An error occurred deleting the selected user groups: You are trying to delete [Test User Group]. User Groups that have assigned members may not be removed. Please remove all members first.', 
    selenium.getText('//div[contains(text(),"An error occurred deleting the selected user group")]'))

WebUI.refresh()

WebUI.setText(findTestObject('Convergence/Security/User Groups/txt_Search Filter'), 'Test User Group')

assertEquals('Test User Group', selenium.getText('//a[contains(text(),"Test User Group")]'))

selenium.click('//a[contains(text(),"Test User Group")]')

WebUI.click(findTestObject('Convergence/Security/User Groups/_User Group Details/_Members Tab/chkbox_Select All'))

WebUI.click(findTestObject('Convergence/Security/User Groups/_User Group Details/_Members Tab/btn_Delete Member'), FailureHandling.STOP_ON_FAILURE)
