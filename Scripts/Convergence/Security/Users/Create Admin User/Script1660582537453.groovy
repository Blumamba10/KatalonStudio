...
WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_User Name'), 'AdminUser')

WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_Description'), 'Admin User')
...
WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_New Password'), '/3ju_$gMW]X}izW4')

WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_Re-enter Password'), '/3ju_$gMW]X}izW4')
...
WebUI.setText(findTestObject('Convergence/Security/Users/_User Detail/Roles Tab/Update User Roles/txt_Search Filter'), 'USERS_ADMIN')
...
WebUI.setText(findTestObject('Convergence/Security/Users/txt_Search FIlter'), 'AdminUser')

assertEquals('AdminUser', selenium.getText('//a[contains(text(),"AdminUser")]'))
