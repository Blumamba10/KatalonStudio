...
WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_User Name'), 'EditLogSetting')

WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_Description'), 'Edit Log Setting User')
...
WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_New Password'), '1/)@Q9?t%*&omvj<')

WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_Re-enter Password'), '1/)@Q9?t%*&omvj<')
...
WebUI.setText(findTestObject('Convergence/Security/Users/_User Detail/Roles Tab/Update User Roles/txt_Search Filter'), 'EDIT_LOG_SETTINGS')
