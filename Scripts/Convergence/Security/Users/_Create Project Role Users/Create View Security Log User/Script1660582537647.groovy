...
WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_User Name'), 'viewsecurityloguser')

WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_Description'), 'View Security Log User')
...
WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_New Password'), '/3ju_$htL]X}izW4')

WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_Re-enter Password'), '/3ju_$htL]X}izW4')
...
WebUI.setText(findTestObject('Convergence/Security/Users/_User Detail/Roles Tab/Update User Roles/txt_Search Filter'), 'VIEW_SECURITY_LOG')
...
WebUI.setText(findTestObject('Convergence/Security/Users/txt_Search FIlter'), 'viewsecurityloguser')

assertEquals('viewsecurityloguser', selenium.getText('//a[contains(text(),"viewsecurityloguser")]'))
