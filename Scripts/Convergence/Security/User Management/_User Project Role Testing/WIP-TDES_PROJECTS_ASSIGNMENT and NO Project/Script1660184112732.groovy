...
WebUI.setText(findTestObject('Convergence/Security/Users/txt_Search FIlter'), 'projectass')

assertEquals('projectass', selenium.getText('//a[contains(text(),"projectass")]'))

selenium.click('//a[contains(text(),"projectass")]')
