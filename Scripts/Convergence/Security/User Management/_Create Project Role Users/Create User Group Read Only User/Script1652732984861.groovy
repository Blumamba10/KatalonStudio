...
WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_User Name'), 'usergroupreadonly')

WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_Description'), 'User Group Read Only User')
...
WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_New Password'), 'e7}m?8bzbYnjOo@%')

WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_Re-enter Password'), 'e7}m?8bzbYnjOo@%')
...
WebUI.setText(findTestObject('Convergence/Security/Users/_User Detail/Roles Tab/Update User Roles/txt_Search Filter'), 'USERGROUPS_READONLY')
