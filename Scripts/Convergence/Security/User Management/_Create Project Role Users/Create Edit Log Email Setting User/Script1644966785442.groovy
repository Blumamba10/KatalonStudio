...
WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_User Name'), 'EditLogEmailSettings')

WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_Description'), 'Edit Log Email Settings User')
...
WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_New Password'), '_YCNI)RnbNje^F4t')

WebUI.setText(findTestObject('Convergence/Security/Users/Add User Account/txt_Re-enter Password'), '_YCNI)RnbNje^F4t')
...
WebUI.setText(findTestObject('Convergence/Security/Users/_User Detail/Roles Tab/Update User Roles/txt_Search Filter'), 'EDIT_LOG_EMAIL_SETTINGS')
...
WebUI.setText(findTestObject('Convergence/Security/Users/txt_Search FIlter'), 'EditLogEmailSettings')

assertEquals('EditLogEmailSettings', selenium.getText('//a[contains(text(),"EditLogEmailSettings")]'))
