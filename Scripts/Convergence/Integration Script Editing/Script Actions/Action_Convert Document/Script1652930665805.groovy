...
WebUI.click(findTestObject('Convergence/Scripts/Manage Scripts/Script Editor_Page/Actions/a_ConvertDocument'))
...
WebUI.setText(findTestObject('Convergence/Scripts/Manage Scripts/input_Search Filter'), 'Convert Document')
