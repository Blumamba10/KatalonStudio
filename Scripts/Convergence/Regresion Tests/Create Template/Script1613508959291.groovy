...
WebUI.selectOptionByValue(findTestObject('Convergence/Templates/ManageTemplates_Page/Template Editor/Form Type_dropdown'), 
    'text-mask', false)

WebUI.selectOptionByValue(findTestObject('Convergence/Templates/ManageTemplates_Page/Template Editor/Input Mask_dropdown'), 
    'ssn', false)
