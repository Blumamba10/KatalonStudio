...
WebUI.callTestCase(findTestCase('Convergence/Server Admin/Security/User Group/_Enable User Group/_Helper/Create New User Group for Indiviual Members'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Convergence/Server Admin/Security/User Group/_Enable User Group/_Helper/Add Project Roles to User Group'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Convergence/Server Admin/Security/User Group/_Enable User Group/_Helper/Add Permissions to User Group'), 
    [:], FailureHandling.STOP_ON_FAILURE)
