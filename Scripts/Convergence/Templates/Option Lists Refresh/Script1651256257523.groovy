...
selenium.click('//thead/tr[1]/th[1]/input[1]')

selenium.click('//tbody/tr[1]/td[2]/a[1]')

selenium.click('//body/form[@id="optionListOptions"]/div[1]/div[1]/div[1]/div[1]/h1[1]/a[1]/i[1]')

WebUI.verifyElementNotChecked(findTestObject('Convergence/z_One Offs/input_Size_id'), 2)
