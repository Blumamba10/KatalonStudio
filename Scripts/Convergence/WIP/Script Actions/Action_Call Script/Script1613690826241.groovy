...
selenium.type('id=scriptNameInput', 'Call Script')
...
assertTrue(selenium.isElementPresent('//button[@id="ininputMenuToggle"]'))
...
assertEquals('Call Script', selenium.getText('//a[@class="new-editor-open"]'))
