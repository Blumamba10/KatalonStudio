...
WebUI.click(findTestObject('Convergence/Scripts/ManageFunctionsPage/Script Editor_Page/_Select an Action or Script_popup/Actions/a_ConvertDocument'))
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScriptsPage/input_Search Filter'), 'Convert Document')
