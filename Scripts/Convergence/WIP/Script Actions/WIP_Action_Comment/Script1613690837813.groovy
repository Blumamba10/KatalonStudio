...
WebUI.click(findTestObject('Convergence/Scripts/ManageFunctionsPage/Script Editor_Page/_Select an Action or Script_popup/Actions/a_Comment'))
...
WebUI.switchToFrame(findTestObject('Convergence/Scripts/ManageFunctionsPage/Script Editor_Page/Page_Convergence Script Editor/iframe'), 
    10)

WebUI.click(findTestObject('Convergence/Scripts/ManageFunctionsPage/Script Editor_Page/Page_Convergence Script Editor/body_Comment'))

WebUI.setText(findTestObject('Convergence/Scripts/ManageFunctionsPage/Script Editor_Page/Page_Convergence Script Editor/body_Comment'), 
    'This is a comment!')
