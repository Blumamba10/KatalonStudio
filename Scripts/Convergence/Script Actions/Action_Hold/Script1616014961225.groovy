...
selenium.type('id=scriptNameInput', 'Hold')
...
selenium.type('id=scriptDescriptionInput', 'Hold')
...
assertEquals('Retry after...', selenium.getText('//label[contains(text(),"Retry after...")]'))
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Hold')

assertEquals('Hold', selenium.getText('//a[@class="new-editor-open"]'))
