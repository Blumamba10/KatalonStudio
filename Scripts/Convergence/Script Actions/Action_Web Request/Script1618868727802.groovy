...
selenium.typeKeys('id=scriptNameInput', 'WebRequest')
...
selenium.typeKeys('id=scriptDescriptionInput', 'WebRequest')
...
assertEquals('Request Part', selenium.getText('//label[@for="RequestPartSelectTriggerInput"]'))

assertEquals('Get ActionGet User IdGet User DescriptionGet ValueGet ValuesHas Role?Body is File?Get BodyGet PathGet Header ValueGet Header ValuesGet MethodGet Request Values', 
    selenium.getText('id=RequestPartSelectTriggerInput'))

selenium.typeKeys('id=nameInput', 'WebRequest')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'WebRequest')

assertEquals('WebRequest', selenium.getText('//a[@class="new-editor-open"]'))
