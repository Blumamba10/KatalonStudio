...
selenium.type('id=scriptNameInput', 'Error')
...
assertEquals('Description', selenium.getText('//label[@for="description"]'))
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Error')

assertEquals('Error', selenium.getText('//a[@class="new-editor-open"]'))
