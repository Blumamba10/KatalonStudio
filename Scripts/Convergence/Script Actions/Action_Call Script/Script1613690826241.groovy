...
WebUI.callTestCase(findTestCase('Convergence/Regresion Tests/5- Gloabal Function Creation'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Call Script')
