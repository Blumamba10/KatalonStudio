...
selenium.type('id=scriptNameInput', 'HL7 Util')
...
selenium.type('id=scriptDescriptionInput', 'HL7 Util')
...
assertEquals("HL7Util", selenium.getText('//h4[@class="modal-title"]'));
...
assertEquals("HL7 version supported", selenium.getText('//div[@class="tse-param-help ng-star-inserted"]'));
assertEquals("Mode", selenium.getText('//label[@for="ModeSelectTriggerInput"]'));
assertEquals("Get Current Time As HL7 TimestampGet Date As HL7 TimestampGet HL7 Timestamp As DateGet HL7 Timestamp As DateTime", selenium.getText("id=ModeSelectTriggerInput"));
selenium.click("id=nameInput")
selenium.typeKeys("id=nameInput", "HL7Util")
...
assertEquals("Date to convert", selenium.getText('//label[@for="DatetoconvertInput"]'));

assertTrue(selenium.isElementPresent('//button[@id="DatetoconvertInputMenuToggle"]'));

selenium.click("xpath=(.//*[normalize-space(text()) and normalize-space(.)='Date to convert'])[1]/following::input[1]")
selenium.typeKeys("xpath=(.//*[normalize-space(text()) and normalize-space(.)='Date to convert'])[1]/following::input[1]", "MM/dd/yyyy")
...
WebUI.setText(findTestObject('Convergence/Scripts/Manage Scripts/input_Search Filter'), 'HL7 Util')

assertEquals('HL7 Util', selenium.getText('//a[@class="new-editor-open"]'))