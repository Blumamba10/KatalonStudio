...
selenium.typeKeys('id=scriptNameInput', 'Web Auth Response')
...
selenium.typeKeys('id=scriptDescriptionInput', 'Web Auth Response')
...
assertEquals('Success', selenium.getText('//label[@for="SuccessInput"]'))
...
selenium.typeKeys('id=nameInput', 'WebAuthRespose')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Web Auth Response')
