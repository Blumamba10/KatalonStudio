...
selenium.type('id=scriptNameInput', 'Create XML')
...
selenium.typeKeys('//span[contains(text(),"")]', 'Test')

WebUI.click(findTestObject('Convergence/Scripts/ManageFunctions_Page/Script Editor_Page/Page_Convergence Script Editor/pre_'))

WebUI.setText(findTestObject('Convergence/Scripts/ManageFunctions_Page/Script Editor_Page/Page_Convergence Script Editor/textarea'), 
    'Test')
