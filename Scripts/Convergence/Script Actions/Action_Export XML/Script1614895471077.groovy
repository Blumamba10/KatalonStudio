...
selenium.type('id=scriptNameInput', 'Export XML')
...
assertEquals('XML Data', selenium.getText('//label[@for="exportXmlDataInput"]'))

assertTrue(selenium.isElementPresent('//input[@id="exportXmlDataInput"]'))

assertEquals('Export As', selenium.getText('//label[contains(text(),"Export As")]'))

assertTrue(selenium.isElementPresent('id=exportAsRadioText'))

assertEquals('Text', selenium.getText('//label[contains(text(),"Text")]'))

assertTrue(selenium.isElementPresent('id=exportAsRadioFile'))

assertEquals('File', selenium.getText('//label[contains(text(),"File")]'))
...
selenium.click('//input[@id="exportXmlDataInput"]')

selenium.typeKeys('//input[@id="exportXmlDataInput"]', 'XML_Data')

selenium.click('//label[contains(text(),"File")]')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Export XML')

assertEquals('Export XML', selenium.getText('//a[@class="new-editor-open"]'))
