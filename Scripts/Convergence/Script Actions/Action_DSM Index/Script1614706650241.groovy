...
selenium.type('id=scriptNameInput', 'DSM Index')
...
assertEquals('Index Fields', selenium.getText('//h6[@class="mt-3"]'))
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'DSM Index')

assertEquals('DSM Index', selenium.getText('//a[@class="new-editor-open"]'))
