...
selenium.typeKeys('id=scriptNameInput', 'Web Init')
...
selenium.typeKeys('id=scriptDescriptionInput', 'Web Init')
...
assertEquals('Configure Web View SecurityConfigure Convergence Web Form StylesConfigure General SettingsConfigure Administration Console SettingsConfigure NTLMConfigure SAMLConfigure Token AuthenticationConfigure OAuth Authentication', 
    selenium.getText('//select[@id="ModeSelectTriggerInput"]'))

selenium.click('id=nameInput')

selenium.typeKeys('id=nameInput', 'WebInit')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Web Init')

assertEquals('Web Init', selenium.getText('//a[@class="new-editor-open"]'))
