...
selenium.typeKeys('id=scriptNameInput', 'Save Point')
...
selenium.typeKeys('id=scriptDescriptionInput', 'Save Point')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Save Point')

assertEquals('Save Point', selenium.getText('//a[@class="new-editor-open"]'))
