...
selenium.typeKeys('id=scriptNameInput', 'Query')
...
selenium.typeKeys('id=scriptDescriptionInput', 'Query')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Query')

assertEquals('Queryr', selenium.getText('//a[@class="new-editor-open"]'))