...
selenium.typeKeys('id=scriptNameInput', 'WebSession')
...
selenium.typeKeys('id=scriptDescriptionInput', 'WebSession')
...
selenium.typeKeys('//input[@id="searchActions"]', 'WebSession')
...
selenium.typeKeys('id=nameInput', 'WebSession')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'WebSession')

assertEquals('WebSession', selenium.getText('//a[@class="new-editor-open"]'))
