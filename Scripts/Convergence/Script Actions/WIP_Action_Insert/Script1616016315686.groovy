...
selenium.type('id=scriptNameInput', 'Insert')
...
selenium.type('id=scriptDescriptionInput', 'Insert')
...
selenium.typeKeys('xpath=//pre[contains(@class,"CodeMirror-line")]', 'Test')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Insert')

assertEquals('Insert', selenium.getText('//a[@class="new-editor-open"]'))