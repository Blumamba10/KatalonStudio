...
selenium.typeKeys('id=scriptNameInput', 'Nav Configurator')
...
selenium.typeKeys('id=scriptDescriptionInput', 'Nav Configurator')
...
assertEquals('Show Advanced Options', selenium.getText('//label[@for="ShowAdvancedOptionsSelectTriggerInput"]'))

assertEquals('YesNo', selenium.getText('id=ShowAdvancedOptionsSelectTriggerInput'))

selenium.click('id=nameInput')

selenium.typeKeys('id=nameInput', 'NavConfigurator')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Nav Configurator')

assertEquals('Nav Configurator', selenium.getText('//a[@class="new-editor-open"]'))
