...
selenium.typeKeys('id=scriptNameInput', 'String Utils')
...
selenium.typeKeys('id=scriptDescriptionInput', 'String Utils')
...
assertEquals('Ignore Case', selenium.getText('//label[@for="IgnoreCaseSelectInput"]'))

assertEquals('NOYES', selenium.getText('id=IgnoreCaseSelectInput'))

selenium.click('id=nameInput')

selenium.typeKeys('id=nameInput', 'StringUtils')
...
selenium.typeKeys('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'Delimeter\'])[1]/following::input[1]', 'Delimeter')

selenium.click('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'Value 1\'])[1]/following::input[1]')

selenium.typeKeys('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'Value 1\'])[1]/following::input[1]', 'value 1')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'String Utils')

assertEquals('String Utils', selenium.getText('//a[@class="new-editor-open"]'))
