...
selenium.type('id=scriptNameInput', 'Intake Web Auth Request')
...
selenium.type('id=scriptDescriptionInput', 'Intake Web Auth Request')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Intake Web Auth Request')

assertEquals('Intake Web Auth Request', selenium.getText('//a[@class="new-editor-open"]'))
