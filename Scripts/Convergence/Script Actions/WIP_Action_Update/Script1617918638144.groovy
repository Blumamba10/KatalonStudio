...
selenium.typeKeys('id=scriptNameInput', 'Update')
...
selenium.typeKeys('id=scriptDescriptionInput', 'Update')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Update')

assertEquals('Update', selenium.getText('//a[@class="new-editor-open"]'))
