...
selenium.typeKeys('id=scriptNameInput', 'QueryUser')
...
selenium.typeKeys('id=scriptDescriptionInput', 'QueryUser')
...
assertEquals('Query Action', selenium.getText('//label[@for="QueryActionSelectTriggerInput"]'))

assertEquals('User Id', selenium.getText('//label[@for="UserIdInput"]'))
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'QueryUser')

assertEquals('QueryUser', selenium.getText('//a[@class="new-editor-open"]'))
