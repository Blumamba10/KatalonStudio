...
selenium.typeKeys('id=scriptNameInput', 'Password Generator')
...
selenium.typeKeys('id=scriptDescriptionInput', 'Password Generator')
...
selenium.typeKeys('id=nameInput', 'PasswordGenerator')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Password Generator')

assertEquals('Password Generator', selenium.getText('//a[@class="new-editor-open"]'))
