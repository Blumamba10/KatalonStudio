...
selenium.typeKeys('id=scriptNameInput', 'Transform XML')
...
selenium.typeKeys('id=scriptDescriptionInput', 'Transform XML')
...
assertEquals('XML Data', selenium.getText('//label[contains(text(),"XML Data")]'))
...
assertEquals('XSLT Data', selenium.getText('//label[contains(text(),"XSLT Data")]'))
...
selenium.typeKeys('id=nameInput', 'Transform_XML')

selenium.typeKeys('id=descriptionInput', 'Description')

selenium.typeKeys('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'XML Data\'])[1]/following::input[1]', 'XML')

selenium.typeKeys('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'XSLT Data\'])[1]/following::input[1]', 'XSLT')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Transform XML')

assertEquals('Transform XML', selenium.getText('//a[@class="new-editor-open"]'))
