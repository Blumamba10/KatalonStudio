...
selenium.type('id=scriptNameInput', 'Update Form')
...
selenium.type('id=scriptDescriptionInput', 'Update Form')
...
assertEquals('Action', selenium.getText('//label[@for="ActionSelectTriggerInput"]'))

assertEquals('CreateUpdate', selenium.getText('//select[@id="ActionSelectTriggerInput"]'))

assertEquals('Associate Image', selenium.getText('//label[@for="AssociateImageSelectTriggerInput"]'))
...
assertEquals('Attribute Count', selenium.getText('//label[@for="AttributeCountTriggerInput"]'))

selenium.typeKeys('id=nameInput', 'Update Form')
...
WebUI.setText(findTestObject('Convergence/Scripts/ManageScripts_Page/input_Search Filter'), 'Update Form')

assertEquals('Update Form', selenium.getText('//a[@class="new-editor-open"]'))
