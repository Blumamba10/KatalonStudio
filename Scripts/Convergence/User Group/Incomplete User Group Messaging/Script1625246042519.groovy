...
assertEquals('Incomplete User Group', selenium.getText('//table[@id="fdv-main-tabs-members-individualMembers-data-table"]//tbody//tr[@class="odd"]//td[contains(text(),"Incomplete User Group")]'))
...
assertEquals('Group is assigned at least one permission', selenium.getText('//li[contains(text(),"Group is assigned at least one permission")]'))
...
selenium.click('//div[@class="ui-dialog tcc-messaging-dialog tcc-dialog-info ui-widget ui-widget-content ui-front ui-dialog-buttons ui-draggable ui-resizable"]//div[@class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"]//div[@class="ui-dialog-buttonset"]//button[@type="button"][contains(text(),"OK")]')
