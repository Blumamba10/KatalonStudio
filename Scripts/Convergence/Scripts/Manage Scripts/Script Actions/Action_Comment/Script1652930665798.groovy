...
WebUI.setText(findTestObject('Convergence/Scripts/Manage Scripts/input_Search Filter'), 'Comment')

assertEquals('Comment', selenium.getText('//a[@class="new-editor-open"]'))
