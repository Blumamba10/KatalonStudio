...
selenium.typeKeys('id=scriptNameInput', 'Remove Server Object')
...
selenium.typeKeys('id=scriptDescriptionInput', 'Remove Server Object')
...
assertEquals("RemoveServerObject", selenium.getText('//h4[@class="modal-title"]'));
...
assertEquals("Object Type", selenium.getText('//label[@for="ObjectTypeSelectTriggerInput"]'));
...
assertEquals("Remove Media", selenium.getText('//label[@for="RemoveMediaSelectInput"]'));
assertEquals("YesNo", selenium.getText("id=RemoveMediaSelectInput"));
assertEquals("This will remove the media associated with the specified form or document, if present.", selenium.getText('//div[contains(text(),"This will remove the media associated with the spe")]'));
assertEquals("Fail if Object not found", selenium.getText('//label[@for="FailifObjectnotfoundSelectInput"]'));
assertEquals("YesNo", selenium.getText("id=FailifObjectnotfoundSelectInput"));
selenium.click("id=nameInput")
selenium.typeKeys("id=nameInput", "RemoveServerObject")
...
WebUI.setText(findTestObject('Convergence/Scripts/Manage Scripts/input_Search Filter'), 'Remove Server Object')

assertEquals('Remove Server Object', selenium.getText('//a[@class="new-editor-open"]'))
