...
selenium.type('id=scriptNameInput', 'DateUtils')
...
selenium.type('id=scriptDescriptionInput', 'DateUtils')
...
assertEquals('DateUtils', selenium.getText('//h4[@class="modal-title"]'))
...
assertEquals('Date PeriodDate Values', selenium.getText('//select[@id="ModeSelectTriggerInput"]'))

assertEquals('It accepts a date string and returns the begin and end date for a period.', selenium.getText('//div[@class="tse-param-help ng-star-inserted"]'))

assertEquals('Date', selenium.getText('//label[@for="DateInput"]'))

assertTrue(selenium.isEditable('//input[@id="DateInput"]'))

assertTrue(selenium.isElementPresent('//input[@id="DateInput"]'))

selenium.click('id=nameInput')

selenium.typeKeys('id=nameInput', 'DateUtils')
...
WebUI.setText(findTestObject('Convergence/Scripts/Manage Scripts/input_Search Filter'), 'DateUtils')

assertEquals('DateUtils', selenium.getText('//a[@class="new-editor-open"]'))
