...
WebUI.click(findTestObject('Convergence/Scripts/Manage Scripts/Script Editor_Page/Actions/a_AuthUser'))
...
WebUI.setText(findTestObject('Convergence/Scripts/Manage Scripts/input_Search Filter'), 'Auth User')
