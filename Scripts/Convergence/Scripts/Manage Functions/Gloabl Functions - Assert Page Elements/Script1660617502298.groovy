...
assertEquals('Name', selenium.getText('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'Processing...\'])[1]/following::th[2]'))
...
assertTrue(selenium.isElementPresent('//i[@class="shortcut-icon fas fa-plus-circle"]'))
