...
WebUI.verifyElementPresent(findTestObject('Convergence/Document Management_Pages/DocumentTypes_Page/copyDocTypeButton'), 
    0, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Convergence/Document Management_Pages/DocumentTypes_Page/createDocTypeButton'), 
    0, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Convergence/Document Management_Pages/DocumentTypes_Page/exportCmsTypeButton'), 
    0, FailureHandling.STOP_ON_FAILURE)
