...
WebUI.click(findTestObject('Convergence/_NavigationLinks/Administration Console/a_Standard Log Viewer'))

assertTrue(selenium.isElementPresent('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'Build:\'])[1]/following::i[1]'))

assertEquals('Log entries are ordered most recent to oldest.', selenium.getText('//em'))

assertTrue(selenium.isElementPresent('id=nextButton'))

assertTrue(selenium.isElementPresent('id=refreshButton'))

assertTrue(selenium.isElementPresent('//h1/a/i'))
...
selenium.click('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'Update\'])[1]/following::div[3]')
