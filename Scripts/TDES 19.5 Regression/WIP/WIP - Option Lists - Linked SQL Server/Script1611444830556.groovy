...
assertEquals('database', selenium.getText('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'configDataSource\'])[1]/following::label[1]'))
...
selenium.click('xpath=(.//*[normalize-space(text()) and normalize-space(.)=\'database\'])[1]/following::option[39]')

selenium.click('id=tableSelect')

selenium.select('id=tableSelect', 'label=tdes_user')
