...
CustomKeywords.'cutomKeywords.LoginHelper.loginConvergence'(GlobalVariable.tdesURL, 'admin', 'admin')
...
WebUI.click(findTestObject('Convergence/Scripts/MonitorPage/History View_btn'))

WebUI.click(findTestObject('Convergence/Scripts/MonitorPage/History Queue_Page/a_onbase-foundep2-test'))

String message = WebUI.getText(findTestObject('Convergence/Scripts/MonitorPage/History Queue_Page/Page_/OnBaseTest/result'))
