...
assertEquals("Welcome to the Trinisys Convergence product reference site!  Here you will find sample implementations of various Web Platform and Integration features.  Use the navigation at the top of the page to browse the examples by category.  New examples will be added to the site on an ongoing basis, so check back often.", selenium.getText("//div[@id='lbl-label']/p"));
assertEquals("Some of the examples found on the site will have links directly to the template and/or script used in the example.   You can also log directly into the Convergence Adminstrative Console using the link below:", selenium.getText("//div[@id='lbl-label']/p[2]"));
